            ...
            <div class="col-sm-12 col-md-12 col-lg-12 col-xl-12 col-xxl-12">
                <div class="card-header justify-content-center">
                    <div class="card-title text-center mb-4 col-12 d-grid justify-content-center">
                        <h2 class="border border-2 border-dark rounded-4 p-2"><strong>EDITAR - USUARIOS</strong></h2>
                    </div>
                                ...
                                <div class="col-12 col-md-6">
                                    <div class="mb-5 col-12 mx-auto">
                                        ...
                                        <select id="Rol" class="form-select" name="rol" required>
                                            ...
                                            $sql = $conexion->query("SELECT id, rol FROM roles WHERE id IN (1,2)");
                                            while ($resultado = $sql->fetch_assoc()) {
                                                $selected = ($resultado['id'] == $row['rol']) ? "selected" : "";
